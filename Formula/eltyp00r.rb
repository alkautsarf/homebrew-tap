class Eltyp00r < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/alkautsarf/eltyp00r/releases/download/v0.1.1/eltyp00r-v0.1.1-darwin-arm64.tar.gz"
      sha256 "83f3b1b1e3690763cebeb34aca746939de8ed49e51e2f7a57386f1433e174c1a"
    end
  end
